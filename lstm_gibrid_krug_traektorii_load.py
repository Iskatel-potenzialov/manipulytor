...
BLEND_CONFIG = {
    ...
    'start_step': 50,         # Начинать наведение за 150 шагов 
}
...
LOAD_TRAJECTORIES =   True   # Загружать траектории из файла вместо генерации
TRAJECTORY_FILE = "trajectories_15_5.npy"  # Имя файла для сохранения/загрузки 
...
def apply_blending(lstm_pred, target_norm, step, total_steps, start_step, power=1.0):
    """
...
# ----------------------------------------------------------------------------
# Функция выполнения одного перемещения (адаптирована для 5 серво, с поддержкой загруженной траектории)
# ----------------------------------------------------------------------------
def run_trajectory(start_real, target_real, description, precomputed_trajectory=None):
    """
